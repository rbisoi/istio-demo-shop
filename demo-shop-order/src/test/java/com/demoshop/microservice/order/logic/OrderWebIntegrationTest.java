package com.demoshop.microservice.order.logic;
...
import com.demoshop.microservice.order.customer.Customer;
import com.demoshop.microservice.order.customer.CustomerRepository;
import com.demoshop.microservice.order.item.Item;
...
public class OrderWebIntegrationTest {
	...
	public void setup() {
		...
		customer = new Customer("Mohit", "Kumar", "mkumar@test.com", "Lindsay St", "London");
	...
	public void IsTestOrderReturned() {
		...
		assertTrue(order.contains("London"));
	}
