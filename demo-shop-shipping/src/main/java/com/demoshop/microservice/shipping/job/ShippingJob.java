package com.demoshop.microservice.shipping.job;
...
public class ShippingJob {
	...
	private final Logger log = LoggerFactory.getLogger(ShippingJob.class);
	...
	@Autowired
	public ShippingJob(@Value("${order.url}") String url, @Value("${poller.actived:true}") boolean pollingActivated,
