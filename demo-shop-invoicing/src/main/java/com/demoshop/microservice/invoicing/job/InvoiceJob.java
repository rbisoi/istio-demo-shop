package com.demoshop.microservice.invoicing.job;
...
import com.demoshop.microservice.invoicing.Invoice;
import com.demoshop.microservice.invoicing.InvoiceService;

@Component
public class InvoiceJob {

	private final Logger log = LoggerFactory.getLogger(InvoiceJob.class);
	...
	@Autowired
	public InvoiceJob(@Value("${order.url}") String url, @Value("${poller.actived:true}") boolean pollingActivated,
